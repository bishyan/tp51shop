...
<div class="page">
    ...
    <form class="form-horizontal" id="adminHandle" method="post">
        ...
        <input type="hidden" name="admin_id" value="<?php echo htmlentities($admin_info['admin_id']); ?>">
        <!--<input type="hidden" name="auth_code" value="TPSHOP"/>-->
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="admin_name"><em>*</em>用户名</label>
                </dt>
                <dd class="opt">
                    <input type="text" name="admin_name" value="<?php echo htmlentities($admin_info['admin_name']); ?>" id="admin_name" maxlength="20" class="input-txt">
                    <span class="err" id="err_admin_name"></span>
                    <p class="notic">用户名</p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="email" value="<?php echo htmlentities($admin_info['email']); ?>" id="email" class="input-txt" maxlength="40">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="password" name="password" maxlength="18" value="" id="password" class="input-txt">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="role_id">
                        ...
                        <option value="<?php echo htmlentities($role['role_id']); ?>"  <?php if($admin_info['role_id'] == $role['role_id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($role['role_name']); ?></option>
...
<script type="text/javascript">
    ...
    function adsubmit(){
        ...
        $.ajax({
            async:false,
            url:"<?php echo url('/Admin/Admin/updateAdmin?t='); ?>"+Math.random(),
