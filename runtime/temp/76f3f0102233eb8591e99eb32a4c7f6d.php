<?php /*a:1:{s:67:"C:\xampp\htdocs\newshop03\application\admin\view\index\welcome.html";i:1555338219;}*/ ?>
<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <link href="/static/admin/css/index.css" rel="stylesheet" type="text/css">
    <link href="/static/admin/css/perfect-scrollbar.min.css" rel="stylesheet" type="text/css">
    <link href="/static/admin/css/purebox.css" rel="stylesheet" type="text/css">
        ...
        <div class="contentWarp">
            <div class="contentWarp_item clearfix">
                <div class="section_select">
                    <div class="item item_price">
                        <i class="icon"><img src="/static/admin/images/1.png" width="71" height="74"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日订单总数</span>
                        </div>
                    ...
                    <div class="item item_order">
                        <i class="icon"><img src="/static/admin/images/2.png"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日会员总数</span>
                        </div>
                    ...
                    <div class="item item_comment">
                        <i class="icon"><img src="/static/admin/images/3.png" width="90" height="86"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日待审评论数</span>
                        </div>
                    ...
                    <div class="item item_flow">
                        <i class="icon"><img src="/static/admin/images/4.png" width="86"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日访问量</span>
                        </div>
            ...
            <div class="contentWarp_item clearfix">
                <div class="section_order_select">
                    <ul>
                        <li>
                            <a href="/index.php/Admin/Order/index/order_status/0">
                                <i class="ice ice_w"></i>
                        ...
                        <li>
                            <a  href="/index.php/Admin/Goods/goodsList">
                                <i class="ice ice_y"></i>
                        ...
                        <li>
                            <a href="/index.php/Admin/Article/articleList">
                                <i class="ice ice_f"></i>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b>版权所有 © 2012-2027 TPshop开源商城，并保留所有权利。</b></p>
</div>
...
<script type="text/javascript" src="/static/admin/js/jquery.purebox.js"></script>
