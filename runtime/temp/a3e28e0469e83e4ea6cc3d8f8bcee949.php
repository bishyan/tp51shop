<?php /*a:2:{s:67:"C:\xampp\htdocs\newshop03\application\admin\view\role\add_role.html";i:1554732245;s:67:"C:\xampp\htdocs\newshop03\application\admin\view\public\layout.html";i:1553609335;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" action="<?php echo url('/Admin/Role/insertRole'); ?>" id="roleform" method="post">
                ...
                <dd style="margin-left:200px;">
                    ...
                    <div class="ncap-account-container" style="border-top:none;">
                        ...
                        <ul class="ncap-account-container-list">
                            ...
                            <li>
                                <label><input class="checkbox" name="right[]" value="<?php echo htmlentities($v['id']); ?>"  ck="mod-<?php echo htmlentities($k); ?>" type="checkbox"><?php echo htmlentities($v['name']); ?></label>
                            </li>
