...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            <div class="ftitle">
                <h3>角色列表</h3>
                <h5>(共<?php echo count($roles); ?>条记录)</h5>
            </div>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo url('/admin/Role/addRole'); ?>">
            ...
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    ...
                    <tr>
                        ...
                        <td align="left" class="">
                            <div style="text-align: left; width: 100px;"><?php echo htmlentities($role['role_id']); ?></div>
                        </td>
                        <td align="left" class="">
                            <div style="text-align: left; width: 100px;"><?php echo htmlentities($role['role_name']); ?></div>
                        </td>
                        <td align="left" class="">
                            <div style="text-align: left; width: 100px;"><?php echo htmlentities($role['role_desc']); ?></div>
                        </td>
                        <td align="center" class="handle">
                            <div style="text-align: center; width: 170px; max-width:170px;">
                                <a href="<?php echo url('/admin/Role/editRole/role_id/'.$role['role_id']); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                <a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('/admin/Role/delRole'); ?>" data-id="<?php echo htmlentities($role['role_id']); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                            </div>
                        </td>
