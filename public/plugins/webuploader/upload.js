$(function() {
	...
	function webuploader(opts){
		...
		uploader.on( 'uploadSuccess', function( file,data) {
			...
			if(data.state == 'SUCCESS'){
				...
				sLi += '<img src="' + data.url + '" width="100" height="100" onerror="this.src=\'/plugins/webuploader/images/error.png\'">';
	...
	window.Manager = {
		...
		del:function(obj){
			if(!confirm('确定删除吗?')) return false;
		    $.get("/"+moudle+"/Uploadify/delupload",{action:"del", filename:$(obj).attr('data-img')},function(res){
					if(res == 1){
